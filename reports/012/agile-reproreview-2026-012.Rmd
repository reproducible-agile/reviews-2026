...
The paper investigates the effect of five socio-economic factors (votes for right-winged populist party, share of foreigners, share of highly qualified employees, long-term unemployment rate, share of incoming commuters) on different phases of the COVID-19 pandemic. The study uses data from the Robert Koch Institute analysed with ... .  The authors shared the scripts via .... For the purposes of this reproducibility review, we verified the functionality of all scripts and the reported results in Figures 1-7 and in Table 2. The reproduced results were in accordance with the reported results and therefore the reproduction of the paper is considered partially **successful**.
...
```{r, echo=FALSE,out.width="100%",fig.cap="Corresponds to Figure 1 of the reproduced paper",fig.show='hold',fig.align='center'}
knitr::include_graphics('./reproduced/predictorMaps.png')
```

```{r, echo=FALSE,out.width="100%",fig.cap="Corresponds to Figure 2 of the reproduced paper",fig.show='hold',fig.align='center'}
knitr::include_graphics('./reproduced/responseMaps.png')
```

```{r, echo=FALSE,out.width="100%",fig.cap="Corresponds to Figure 3 of the reproduced paper",fig.show='hold',fig.align='center'}
...
```{r, echo=FALSE,out.width="100%",fig.cap="Corresponds to Figure 5 of the reproduced paper",fig.show='hold',fig.align='center'}
knitr::include_graphics('./reproduced/EVeffectMapLinkScale.png')
```


```{r, echo=FALSE,out.width="100%",fig.cap="Corresponds to Figure 7 of the reproduced paper",fig.show='hold',fig.align='center'}
